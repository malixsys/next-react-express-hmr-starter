        ...
        bind: {
          ...
          touchEvents: function () {
            ...
            if (module.is.searchSelection()) {
              ...
              $module.on('touchstart' + eventNamespace, module.event.test.toggleSidebar);
            }
          ...
          mouseEvents: function () {
            ...
            if (module.is.searchSelection()) {
              ...
              if (settings.on == 'click') {
                $module.on('click' + eventNamespace, module.event.test.toggleSidebar);
              } else if (settings.on == 'hover') {
                $module
                  .on('mouseenter' + eventNamespace, module.delay.show)
                  .on('mouseleave' + eventNamespace, module.delay.hide);
              } else {
                $module.on(settings.on + eventNamespace, module.toggleSidebar);
              }
              $module
                .on('click' + eventNamespace, selector.icon, module.event.icon.click)
                .on('mousedown' + eventNamespace, module.event.mousedown)
        ...
        event: {
          ...
          test: {
            toggleSidebar: function (event) {
              var toggleBehavior = module.is.multiple() ? module.show : module.toggleSidebar;
